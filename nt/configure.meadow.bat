...
echo.   --magick DIRECTORY      ImageMagick directory
...
rem ----------------------------------------------------------------------
:genmakefiles
if not (%magick%) == () goto genmakefiles2
echo Error: --magick is not specified.
goto end
...
echo MAGICKDIR=%magick%>>config.settings
...
if %COMPILER% == gcc goto generate_makefiles_for_gmake

rem
rem   Generating makefiles for nmake.
rem 

set MAKECMD=nmake

copy /b config.settings+..\nt\makefile.nmake.mw32-in ..\nt\makefile
copy /b config.settings+..\lib-src\makefile.nt ..\lib-src\makefile
copy /b config.settings+..\src\makefile.nt ..\src\makefile
copy /b config.settings+..\lisp\makefile.nt ..\lisp\makefile
copy /b config.settings+..\leim\makefile.nt ..\leim\makefile
copy /b config.settings+..\leim\Makefile.nt ..\leim\makefile

goto generate_makefile_end

:generate_makefiles_for_gmake
...
copy /b config.settings+%MAKECMD%.meadow.defs+..\nt\makefile.meadow.w32-in ..\nt\makefile
copy /b config.settings+%MAKECMD%.meadow.defs+..\lib-src\makefile.meadow.w32-in ..\lib-src\makefile
copy /b config.settings+%MAKECMD%.meadow.defs+..\src\makefile.meadow.w32-in ..\src\makefile
if exist ..\lisp\makefile rm -f ../lisp/[Mm]akefile
copy /b config.settings+%MAKECMD%.meadow.defs+..\lisp\makefile.meadow.w32-in ..\lisp\makefile
rem   Use the default (no-op) Makefile.in if the nt version is not present.
if exist ..\leim\makefile.meadow.w32-in copy /b config.settings+%MAKECMD%.meadow.defs+..\leim\makefile.meadow.w32-in ..\leim\makefile
if not exist ..\leim\makefile.meadow.w32-in copy /b config.settings+%MAKECMD%.meadow.defs+..\leim\Makefile.in ..\leim\makefile

:generate_makefile_end
