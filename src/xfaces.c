...
#ifdef MEADOW
      {
	MW32LogicalFont *plf = (MW32LogicalFont*) font_info->font;
     ...
     Lisp_Object from, to, invalid, gcpro;
{
  ...
  if (INTEGERP (from))
    ...
    result = (int) (XFLOATINT (from) * XINT (to));
